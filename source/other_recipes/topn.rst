...
The "top N" recipe can have pre-filters. The filters documentation is available :doc:`here  <../other_recipes/sampling>`.

.. seealso::
    For more information, see also the following articles in the Knowledge Base:
    
    - `Concept | Top N recipe <https://knowledge.dataiku.com/latest/data-preparation/visual-recipes/concept-top-n-recipe.html>`_
    - `Tutorial | Top N recipe <https://knowledge.dataiku.com/latest/data-preparation/visual-recipes/tutorial-top-n-recipe.html>`_
