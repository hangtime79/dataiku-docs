...
.. note::
	...
	Contrary to Bokeh, Dash is not installed by default in DSS. We recommend that you create and use a :doc:`code environment </code-envs/index>`. You need to install the `dash` package. You can then choose that code environment in the settings of your Dash webapp.
