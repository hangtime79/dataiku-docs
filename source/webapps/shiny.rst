...
Each time you save your Shiny webapp code, the Shiny server restarts and displays the updated application; You can disable auto-restart in the settings. You can also select the :doc:`code environment </code-envs/index>` in the settings.
