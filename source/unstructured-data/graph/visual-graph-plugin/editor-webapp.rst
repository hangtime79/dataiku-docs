...
.. note::
    ...
    **Get started** by following this `tutorial <https://knowledge.dataiku.com/latest/ml-analytics/visual-graphs/tutorial-visual-graph.html>`_.
...
.. note::
    ...
    Check out the `Dataiku documentation <https://knowledge.dataiku.com/latest/data-sourcing/datasets/concept-dataset-characteristics.html#storage-type>`_ and the `Kùzu data type documentation <https://kuzudb.github.io/docs/cypher/data-types/>`_.
...
-  | **Scalability**
   | Kùzu is `pushing back the limit of scalability <https://kuzudb.github.io/docs/#performance-and-scalability>`_ for embedded graph databases.
...
**Internal Datasets**
    * **Internal Storage Dataset**: select or create the dataset persisting the internal state of the webapp. Any type of underlying storage (FileSystem, S3, SQL,...) is supported.
...
Next topics
------------
**For Business Users**: Configure an :doc:`Explorer <./explorer-webapp>` webapp using this graph for interactive exploration and discovery.
