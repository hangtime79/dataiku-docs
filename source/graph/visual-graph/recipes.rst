...
The **Compute PageRank** recipe calculates the PageRank centrality for nodes in your graph. `This algorithm <https://docs.kuzudb.com/extensions/algo/pagerank/>`_ is a common technique for identifying the most influential nodes based on the graph's structure.
