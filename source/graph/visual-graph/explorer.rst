...
.. note::
    ...
    All schema design, data mapping and visual customization are performed beforehand in the :doc:`Visual Graph Editor <./editor>` webapp.
...
.. note::
    ...
    These queries are prepared by Data Scientists in the :doc:`Editor <./editor>` webapp.
