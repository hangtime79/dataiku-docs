...
Specify the custom date format of the output column using the `Java syntax for date specifier <http://docs.oracle.com/javase/7/docs/api/java/text/SimpleDateFormat.html>`__. 
...
For more information on managing dates with Dataiku DSS, please see the `reference documentation <https://doc.dataiku.com/dss/latest/preparation/dates.html>`__.
