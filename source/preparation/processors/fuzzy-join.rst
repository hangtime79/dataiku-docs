...
.. warning::
  ...
  **Deprecated**: Memory-based fuzzy join processor is deprecated.
  Use a :doc:`dedicated fuzzy join recipe </other_recipes/fuzzy-join>` instead.
...
Since the join is done in memory the main limitation is the dataset size. To overcome this limit there's a :doc:`dedicated fuzzy join recipe </other_recipes/fuzzy-join>` that is a recommended way of using fuzzy join in DSS.
