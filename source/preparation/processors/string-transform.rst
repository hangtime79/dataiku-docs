...
Perform a variety of encoding, decoding, and string transformations on one or several columns. Transformations are always done in-place. For more advanced transformations, use the `Formula processor <https://doc.dataiku.com/dss/latest/preparation/processors/formula.html>`_.
