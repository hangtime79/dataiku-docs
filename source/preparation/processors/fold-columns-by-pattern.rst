.. _fold-multiple-columns-by-pattern:
...
This processor is a variant of Fold multiple columns. Read more about that processor in the `Dataiku documentation <https://doc.dataiku.com/dss/11.0/preparation/processors/fold-columns-by-name.html>`__.