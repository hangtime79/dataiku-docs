...
Setup actions are configuration steps ran by the :ref:`agent <gcp-cloudstacks-concept-agent>`. As a user, you create a list a setup actions you wish to see executed on the machine.
