...
.. note::
	...
	Of course, you can use the regular Linux installation procedure (:doc:`/installation/custom/initial-install`) on any compatible GCP Linux instance.
...
.. warning::
	...
	For production purposes, we strongly recommend using :doc:`/installation/cloudstacks-gcp/index` instead
