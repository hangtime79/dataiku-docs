...
When you create an instance, you *provision* it. Provisioning an instance means FM creates the required cloud resources to host the DSS node. See :ref:`instances lifecycle <azure-cloudstacks-instance-lifecycle>` for more information.
...
.. _azure-cloudstacks-concept-agent:
