...
* If you previously used Impala (in notebooks or charts), you will need to reconfigure Impala connectivity. See :doc:`/hadoop/impala`
* Following an upgrade of the IPython notebook, graphing features must be enabled manually in older Python notebooks.
* After upgrade, you will need to follow again the procedure to :doc:`Install R integration </installation/custom/r>`
...
For more information about Spark integration, see :doc:`/spark/index`
...
To learn more about this API, see :doc:`/publicapi/index`
...
In addition, DSS features a new R API. See :doc:`/R-api/index` for more details.
...
To learn more, see :doc:`devguide:api-reference/python/sql`
