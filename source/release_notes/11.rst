...
----------------------------
    ...
    * From DSS 10.0: Automatic migration is supported, with the restrictions and warnings described in :ref:`releases_notes.11.limitations`

    * From DSS 9.0: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 8.0: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See  :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 7.0: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 6.0: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`6.0 -> 7.0 </release_notes/7.0>`, :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 5.1: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`5.1 -> 6.0 </release_notes/6.0>`, :doc:`6.0 -> 7.0 </release_notes/7.0>`, :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 5.0: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`5.0 -> 5.1 </release_notes/5.1>`, :doc:`5.1 -> 6.0 </release_notes/6.0>`, :doc:`6.0 -> 7.0 </release_notes/7.0>`, :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 4.3: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`4.3 -> 5.0 </release_notes/5.0>`, :doc:`5.0 -> 5.1 </release_notes/5.1>`, :doc:`5.1 -> 6.0 </release_notes/6.0>`, :doc:`6.0 -> 7.0 </release_notes/7.0>`, :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 4.2: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`4.2 -> 4.3 </release_notes/4.3>`, :doc:`4.3 -> 5.0 </release_notes/5.0>`, :doc:`5.0 -> 5.1 </release_notes/5.1>`, :doc:`5.1 -> 6.0 </release_notes/6.0>`, :doc:`6.0 -> 7.0 </release_notes/7.0>`, :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 4.1: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`4.1 -> 4.2 </release_notes/4.2>`, :doc:`4.2 -> 4.3 </release_notes/4.3>`, :doc:`4.3 -> 5.0 </release_notes/5.0>`, :doc:`5.0 -> 5.1 </release_notes/5.1>`, :doc:`5.1 -> 6.0 </release_notes/6.0>`, :doc:`6.0 -> 7.0 </release_notes/7.0>`, :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`

    * From DSS 4.0: Automatic migration is supported. In addition to the restrictions and warnings described in :ref:`releases_notes.11.limitations`, you need to pay attention to the restrictions and warnings applying to your previous versions. See :doc:`4.0 -> 4.1 </release_notes/4.1>`, :doc:`4.1 -> 4.2 </release_notes/4.2>`, :doc:`4.2 -> 4.3 </release_notes/4.3>`, :doc:`4.3 -> 5.0 </release_notes/5.0>`, :doc:`5.0 -> 5.1 </release_notes/5.1>`, :doc:`5.1 -> 6.0 </release_notes/6.0>`, :doc:`6.0 -> 7.0 </release_notes/7.0>`, :doc:`7.0 -> 8.0 </release_notes/8.0>`, :doc:`8.0 -> 9.0 </release_notes/9.0>`, :doc:`9.0 -> 10.0 </release_notes/10.0>`
...
Pay attention to the warnings described in :ref:`releases_notes.11.limitations`.


.. _releases_notes.11.limitations:
...
..
    .. todo::
        I had already written these but too early. Putting them to not waste them :)

        Embed dashboards with filters
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

        DSS dashboards can now be embedded in "minimal" mode. The embedding URL can include a filter state, which allows you to share and embed a particular "view" of a dashboard with an active filter.

        Note that viewers still need to be logged in on DSS with a Reader profile.

        * Made both "Exclude" and "Include" mode available for filters
...
* Fixed :doc:`LDAP Authentication Bypass </security/advisories/dsa-2023-010>`
...
Security
--------
* Fixed :doc:`Aborting scenarios with read-only permission on the project </security/advisories/dsa-2023-026>`
...
Security
----------
* Fixed :doc:`Directory traversal via download action of file editor </security/advisories/dsa-2023-001>`
* Fixed :doc:`Directory traversal through git symlink support abuse </security/advisories/dsa-2023-002>`
...
* Time Series: Added support for CUDA 11.0 and 11.2 in GPU-enabled Visual time series forecasting, see :doc:`/machine-learning/time-series-forecasting/runtime-gpu`
...
Security
-----------------------------------
* Fixed :doc:`Race condition on UIF can lead to account takeover </security/advisories/dsa-2022-023>`
...
* Fixed :doc:`missing authentication on internal API call </security/advisories/dsa-2022-021>`
* Fixed :doc:`XSS issue in notebooks </security/advisories/dsa-2022-022>`
...
.. todo::
    ...
    -- Don't put * Prevented possible javascript error when editing user profile
    -- Don't put * Sentence Embedding: * Improved performance of sentence embedding processing
...
* Fixed :doc:`cross-site-scripting issue through custom metric names </security/advisories/dsa-2022-017>`
* Fixed :doc:`cross-site-scripting issue through imported Jupyter notebooks </security/advisories/dsa-2022-018>`
* Fixed :doc:`HTTP host blacklist bypass </security/advisories/dsa-2022-019>`
* Fixed :doc:`Takeover of Jupyter notebooks </security/advisories/dsa-2022-020>`
...
For more details, please see :doc:`/machine-learning/time-series-forecasting/index`
...
For more details, please see :doc:`/code-studios/index`
...
For more details, please see :doc:`/mlops/experiment-tracking/index`
...
* Data monitoring is implemented using :doc:`Metrics & Checks </scenarios/index>`
...
For more details, please see :doc:`/mlops/feature-store/index`
...
For more details, please see :doc:`/visualization/index`
...
For more details, please see :doc:`/security/shared-objects`
...
For more details, please see :doc:`/collaboration/requests`
...
For more details, please see :doc:`/flow/flow-document-generator`.

Govern: Projects and bundles governance
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

The :doc:`Govern Node </governance/index>` now supports managing, governing, and controlling deployment of Project Bundles in the Deployer
...
For more details, please see :doc:`/installation/cloudstacks-gcp/index`
...
For more details, please see :doc:`/security/sso`
...
For more details, please see :doc:`/installation/index`
...
For more details, please see :doc:`/other_recipes/list-folder-contents`
...
For more details, please see :doc:`/geographic/index`
