...
In order to provide proper governance over access and sharing, the ability to :doc:`share objects </security/permissions>` into a Dataiku Workspace is managed at the project level. 
