...
If you've previously deployed a web application and wish to update it, you can simply [Build the webapp](#step-1-building-the-application), [Synchronize the files](#step-2-synchronize-files-with-dataiku-instance), and restart your web application backend.
```
...
![Sync Files](assets/01-sync-files.png){.image-popup}
...
![New Webapp](assets/02-new-webapp.png){.image-popup}
...
![Application deployed](assets/03-application-deployed.png){.image-popup}
